      ...
      >
       ...
       <SettingsCategoryHeader
        ...
        <TextInput 
          ...
          value={timeValue}
          maxLength={8}/>
        <Button onPress={() => timeValue.trim() && dispatch(addTimeValue(timeValue)) && navigation.navigate('Timer', {paramKey: timeValue})} style={styles.timeValue__button} title="Add num" />
